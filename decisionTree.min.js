...
d=a===c,d&&delete g[c.key]);k.trigger("decisionTree.incomplete")};n=function(a){var b;if(a.requirements)for(b in a=a.requirements,a)if(a.hasOwnProperty(b))if("string"===typeof a[b]){if(f[b]!==a[b])return!1}else if(0>a[b].indexOf(f[b]))return!1;return!0};y=function(a){return 0<=e.indexOf(a)};z=function(a){var b,c,d;b=p('<select id="'+("decision-tree-"+q+"-question-"+a.key)+'" name="'+s+"["+a.key+']" class="decision-tree-question"><option class="default" value="">'+t+" "+a.label+"</option></select>");
for(c in a.options)a.options.hasOwnProperty(c)&&n(a.options[c])&&(d=a.options[c],b.append('<option value="'+c+'">'+(d.label||d)+"</option>"));return b.data("decision-tree-question",a).appendTo(k).hide().fadeIn()};A=function(a){var b,c,d;d=c=0;for(b in a)a.hasOwnProperty(b)&&"number"===typeof a[b]&&(c+=a[b],d+=1);return d?c/d:null};r(B)});return this}})(jQuery);